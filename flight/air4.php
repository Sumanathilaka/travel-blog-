...
$sql = " INSERT INTO dataentry2(flight_name,flight_no,arrival,departure,cost_econ,cost_bus,seat_econ,seat_bus,arrival_time,departure_time) VALUES ('$flight_name','$flight_no','$arrival','$departure','$cost_econ','$cost_bus','$seat_econ','$seat_bus','$arrival_time','$departure_time')";
